...
public class FeatureFlagController {
    ...
    @PatchMapping("/update/{key}")
    public ResponseEntity<FeatureFlagDto> updateToggle(
        @PathVariable String key,
        @RequestBody ToggleUpdateRequest toggleUpdateRequest
    ) {
        System.out.println("Received request to update toggle with key: " + key +
            " with request body: " + toggleUpdateRequest);
        return ResponseEntity.ok(service.updateFlagStatus(key));
    }
